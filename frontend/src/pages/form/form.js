      ...
      <div id="main-form">
        ...
        <div id="container">
          ...
          <form className="form container">
            <h2 className="noselect">Dados gerais<hr class="my-2"></hr></h2>
            ...
            <h2 className="noselect">Atividades didáticas <hr class="my-2"></hr></h2>
            <div className="form-wrapper">
            ...
            <h2 className="noselect">Atividades de pesquisa <hr class="my-2"></hr></h2>
            <div className="content-checkbox">
